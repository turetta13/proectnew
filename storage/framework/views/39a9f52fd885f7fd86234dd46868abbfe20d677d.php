    ...
    <div class="container">
        <div class="row justify-content-center">
            <div>
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('menu.create')); ?>">Добавить категорию</a>
                <table class="table">
                    <tr>
                        <td><b>id</b></td>
                        <td><b>Название</b></td>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <?php if($categorie->parent_id == 0): ?>
                                <td><h4><?php echo e($categorie->id); ?></h4></td>
                            <?php else: ?>
                            ...
                            <td><a input type="submit" onclick="return confirm('Подтвердить удаление')" href="<?php echo e(route('menu.delete',[$categorie->id])); ?>">удалить(!) </a></td>
