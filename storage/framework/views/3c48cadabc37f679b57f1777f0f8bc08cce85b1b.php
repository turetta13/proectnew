    ...
    <div class="container">
        ...
        <div class="header-info">
            ...
            <div class="header-right login">
                <a href="<?php echo e(route('login')); ?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a>
                <div id="loginBox">
                    <form id="loginForm">
                        <fieldset id="body">
                            <fieldset>
                        ...
                        <p><a class="sign" href="<?php echo e(route('register')); ?>">Регистрация</a> <span><a
