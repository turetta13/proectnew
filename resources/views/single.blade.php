                ...
                <div class="col-md-4 single-grid">
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            <li data-thumb="{{$single->image_path_2}}">
                                <div class="thumb-image"><img src="{{$single->image_path_2}}" data-imagezoom="true"
                                                              class="img-responsive"></div>
                            </li>
                            <li data-thumb="{{$single->image_path_3}}">
                                <div class="thumb-image"><img src="{{$single->image_path_3}}" data-imagezoom="true"
                                                              class="img-responsive"></div>
                            </li>
                        </ul>
                    </div>
